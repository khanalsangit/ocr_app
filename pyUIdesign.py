...
"}")
        ...
        self.roiEntry.setMaximumSize(QtCore.QSize(99, 16777215))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.roiEntry.setFont(font)
        self.roiEntry.setAlignment(QtCore.Qt.AlignCenter)
...
"")
        ...
        self.click_Button = QtWidgets.QPushButton(self.saveData_Page)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"border:1px solid;")
        ...
        spacerItem1 = QtWidgets.QSpacerItem(333, 480, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
...
"}")
        ...
        spacerItem2 = QtWidgets.QSpacerItem(20, 231, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        ...
        spacerItem3 = QtWidgets.QSpacerItem(236, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
...
"}")
        ...
        self.gridLayout_11.addWidget(self.elasticEntry, 3, 1, 1, 1, QtCore.Qt.AlignRight)
        ...
        self.gridLayout_11.addWidget(self.elasticLabel, 3, 0, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.rigidLabel, 2, 0, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.rigidEntry, 2, 1, 1, 1, QtCore.Qt.AlignRight)
        self.flipEntry = QtWidgets.QLineEdit(self.frame_17)
        self.flipEntry.setMaximumSize(QtCore.QSize(40, 16777215))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.flipEntry.setFont(font)
        self.flipEntry.setAlignment(QtCore.Qt.AlignCenter)
        self.flipEntry.setObjectName("flipEntry")
        self.gridLayout_11.addWidget(self.flipEntry, 1, 1, 1, 1, QtCore.Qt.AlignRight)
        self.flipLabel = QtWidgets.QLabel(self.frame_17)
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        self.flipLabel.setFont(font)
        self.flipLabel.setObjectName("flipLabel")
        self.gridLayout_11.addWidget(self.flipLabel, 1, 0, 1, 1)
...
"border-radius: 3px;")
        ...
        self.systemSetting_update_Button_debug.setMaximumSize(QtCore.QSize(16777215, 24))
        font = QtGui.QFont()
        font.setFamily("Arial")
        font.setPointSize(10)
        font.setBold(False)
...
"}")
        ...
        spacerItem14 = QtWidgets.QSpacerItem(20, 332, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
