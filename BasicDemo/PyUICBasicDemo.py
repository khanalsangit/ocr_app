...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bnClose.setText(_translate("MainWindow",   "turn off device"))# "关闭设备"))
        self.bnOpen.setText(_translate("MainWindow",    "Open device"))# "打开设备"))
        #self.bnEnum.setText(_translate("MainWindow",    "Find device"))# "查找设备"))
        self.groupGrab.setTitle(_translate("MainWindow",    "collection"))# "采集"))
        self.bnSaveImage.setText(_translate("MainWindow",  "Save image")) # "保存图像"))
        self.radioContinueMode.setText(_translate("MainWindow",     "continuous mode"))# "连续模式"))
        self.radioTriggerMode.setText(_translate("MainWindow", "trigger mode")) # "触发模式"))
        self.bnStop.setText(_translate("MainWindow",    "Stop collection"))# "停止采集"))
        self.bnStart.setText(_translate("MainWindow",  "Start collection")) # "开始采集"))
        self.bnSoftwareTrigger.setText(_translate("MainWindow",     "Soft trigger once"))# "软触发一次"))
        self.groupParam.setTitle(_translate("MainWindow",   "parameter"))# "参数"))
        self.label_6.setText(_translate("MainWindow",   "frame rate"))# "帧率"))
        self.edtGain.setText(_translate("MainWindow",   "0"))# "0"))
        self.label_5.setText(_translate("MainWindow",   "gain"))# "增益"))
        self.label_4.setText(_translate("MainWindow",   "exposure"))# "曝光"))
        self.edtExposureTime.setText(_translate("MainWindow",   "0"))# "0"))
        self.bnGetParam.setText(_translate("MainWindow",    "Get parameters"))# "获取参数"))
        self.bnSetParam.setText(_translate("MainWindow",    "Setting parameters"))# "设置参数"))
        self.edtFrameRate.setText(_translate("MainWindow",  "0"))# "0"))
