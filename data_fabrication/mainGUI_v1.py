...
from data_fabrication.color_picker import ColorApp
from data_fabrication.main_fab_op import create_data
from data_fabrication.fabrication_type import FabricationApp
...
class App(ctk.CTk):
    ...
    def open_warning(self):
        CTkMessagebox(title="Warning Message!", message="Load the image First!",icon="warning", option_1="Ok")
    ...
    def generate_data(self):
        try:
            ...
            ###========completion message=======######
            CTkMessagebox(title="Complete",message="Data Fabrication Completed",icon="check", option_1="Ok")
