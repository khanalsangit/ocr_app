...
class FabricationApp(tk.Toplevel):
    def __init__(self):
        ...
        ####+========= Load images ========###########
        original_images = [
            Image.open("data_fabrication/fabrication_type_1.png"),
            Image.open("data_fabrication/fabrication_type_2.png"),
            Image.open("data_fabrication/fabrication_type_3.png"),
            Image.open("data_fabrication/fabrication_type_4.png")
        ]
    ...
    def change_color(self, index):
        try:
            ...
            CTkMessagebox(title="Image selected",message=f"Image {index+1} is selected",icon="check", option_1="Ok")
            self.selected_index = index
        except:
            CTkMessagebox(title="Error",message="Image not selected",icon="warning",option_1="Ok")
